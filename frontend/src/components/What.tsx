...
export function What() {
  ...
  return (
    <div className="create-container pt-5 pb-0 px-5" id="what">
        <p>
            This tool allows you to interact with any smart contract on any EVM (Ethereum Virtual Machine) based blockchain.
        ...
        <p>
            ...
            Support may be requested but is not guaranteed.
        </p>
    </div>
